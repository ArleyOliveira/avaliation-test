...
class CheckIfExistPhysicalUserByCpfValidatorTest extends TestCase
{
    private $repository;
    ...
    public function shouldBeValidWhenNotExist() {
        ...
        $validator = new CheckIfExistPhysicalUserByCpfValidator(
            'cpf','00011122233', 1, $this->repository
        );
    ...
    public function shouldBeValidWhenExistButIgnoredUserBy() {
        ...
        $validator = new CheckIfExistUserByEmailValidator(
            'cpf','00011122233', $ignoreUserId, $this->repository
        );
